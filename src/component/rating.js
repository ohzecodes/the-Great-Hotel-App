...
export default function Rating(props) {
  const [starSelect, setstarSelect] = props.setrating;
  ...
  for (let i = 1; i <= Tstars; i++) {
    ...
    btnarray.push(
      ...
      >
        ...
        <path
          style={{ strokeColor: "black", stroke: "black", strokeWidth: "10px" }}
  ...
  return (
    <>
      <div style={props.style}>{btnarray}</div>
      {/* <div
